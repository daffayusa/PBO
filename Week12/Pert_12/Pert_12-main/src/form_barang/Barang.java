...
public class Barang extends javax.swing.JFrame {
    ...
    static final String DB_URL = "jdbc:mysql://127.0.0.1/penjualann";
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                .addGroup(layout.createSequentialGroup()
                                                    ...
                                                    .addComponent(txtStok, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addGroup(layout.createSequentialGroup()
                                                    .addComponent(jLabel4)
                                                    .addGap(18, 18, 18)
                                                    .addComponent(txtStokMin, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                            .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    public void update(String kode, String nm_barang, String satuan, int stok, int stok_min){
        try {
            ...
            if (choice == 0) {
                ...
                String updateQuery = "UPDATE barang SET stock = '" + newValue + "' WHERE id = " + id;
...
//            stmt = conn.createStatement();
            ...
            if(count > 0){
                ...
                String insertSql = "Insert Into barang (kd_brg,nama_brg,satuan,stock,stock_min) VALUES (?,?,?,?,?)"; 
